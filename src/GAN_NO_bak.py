...
class GAN:
    def __init__(self, t, x, y, p, u, v):
        ...
        self.model_path = '../models/gan/1 0 1_no_bak/gan{0}.ckpt'
        self.model_load_path = '../models/gan/1 0 1_no_bak'
        ...
        self.g_loss = 1 * self.l2_Loss + 0 * self.pde_residuals + 1 * self.entropy_loss
    ...
    def train(self):
        ...
        log_save_path = '../results/gan/1 0 1_no_bak/loss.txt'
...
if __name__ == '__main__':
    ...
    np.save('../results/gan/1 0 1_no_bak/pressure{0}.npy'.format(test_t[0]), g_p)
    np.save('../results/gan/1 0 1_no_bak/velocity_u{0}.npy'.format(test_t[0]), g_u)
    np.save('../results/gan/1 0 1_no_bak/velocity_v{0}.npy'.format(test_t[0]), g_v)
