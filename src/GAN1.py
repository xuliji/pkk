...
class GAN:
    def __init__(self, t, x, y, p, u, v):
        ...
        self.model_path = '../models/gan/1 0.1 1/gan{0}.ckpt'
        self.model_load_path = '../models/gan/1 0.1 1'
    ...
    def train(self):
        ...
        log_save_path = '../results/gan/1 0.1 1/loss.txt'
...
if __name__ == '__main__':
    ...
    np.save('../results/gan/1 0.1 1/pressure{0}.npy'.format(test_t[0]), g_p)
    np.save('../results/gan/1 0.1 1/velocity_u{0}.npy'.format(test_t[0]), g_u)
    np.save('../results/gan/1 0.1 1/velocity_v{0}.npy'.format(test_t[0]), g_v)
