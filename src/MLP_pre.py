...
if __name__ == '__main__':
    ...
    for pre_id in range(400,500):
        ...
        np.save('../results/pre/mlp/pressure{0}.npy'.format(test_t[0]), g_p)
        np.save('../results/pre/mlp/velocity_u{0}.npy'.format(test_t[0]), g_u)
        np.save('../results/pre/mlp/velocity_v{0}.npy'.format(test_t[0]), g_v)