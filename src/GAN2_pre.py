...
class GAN:
    def __init__(self, t, x, y, p, u, v):
        ...
        self.model_load_path = '../models/gan/1 0.2 1_'
...
if __name__ == '__main__':
    ...
    for pre_id in range(400, 500):
        ...
        np.save('../results/pre/gan_0.2/pressure{0}.npy'.format(test_t[0]), g_p)
        np.save('../results/pre/gan_0.2/velocity_u{0}.npy'.format(test_t[0]), g_u)
        np.save('../results/pre/gan_0.2/velocity_v{0}.npy'.format(test_t[0]), g_v)