...
if __name__ == '__main__':
    ...
    np.save('../results/mlp/pressure{0}.npy'.format(test_t[0]), g_p)
    np.save('../results/mlp/velocity_u{0}.npy'.format(test_t[0]), g_u)
    np.save('../results/mlp/velocity_v{0}.npy'.format(test_t[0]), g_v)
