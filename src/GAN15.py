...
if __name__ == '__main__':
    ...
    np.save('../results/gan/{1}/pressure{0}.npy'.format(test_t[0], path), g_p)
    np.save('../results/gan/{1}/velocity_u{0}.npy'.format(test_t[0], path), g_u)
    np.save('../results/gan/{1}/velocity_v{0}.npy'.format(test_t[0], path), g_v)
