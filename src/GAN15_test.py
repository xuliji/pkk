...
if __name__ == '__main__':
 ...
 # gan.train()
    ...
    for pre_id in range(time_step_test):
        ...
        np.save('../results/val/gan_1/pressure{0}.npy'.format(test_t[0]), g_p)
        np.save('../results/val/gan_1/velocity_u{0}.npy'.format(test_t[0]), g_u)
        np.save('../results/val/gan_1/velocity_v{0}.npy'.format(test_t[0]), g_v)
