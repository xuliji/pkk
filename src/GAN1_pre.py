...
class GAN:
    def __init__(self, t, x, y, p, u, v):
        ...
        self.model_path = '../models/gan/1 0.5 1_/gan{0}.ckpt'
        self.model_load_path = '../models/gan/1 0.5 1_'
...
if __name__ == '__main__':
    ...
    for pre_id in range(400, 500):
        ...
        np.save('../results/pre/gan_c/pressure{0}.npy'.format(test_t[0]), g_p)
        np.save('../results/pre/gan_c/velocity_u{0}.npy'.format(test_t[0]), g_u)
        np.save('../results/pre/gan_c/velocity_v{0}.npy'.format(test_t[0]), g_v)