...
class MLP:
    ...
    def __init__(self, x_data, y_data, t_data, pressure_data, velocity_u_data, velocity_v_data,
        ...
        self.model_root_path = '../models/mlp_'
        self.model_path = '../models/mlp_/mlp{0}.ckpt'
    ...
    def train(self):
        ...
        log_save_path = '../results/mlp_/loss.txt'
        ...
        for epoch in range(self.epochs):
            ...
            if (epoch + 1) % 10 == 0:
                ...
                train_log(log_save_path, loss_value)
...
if __name__ == '__main__':
    ...
    for pre_id in range(400, 500):
        ...
        np.save('../results/pre/mlp_no/pressure{0}.npy'.format(test_t[0]), g_p)
        np.save('../results/pre/mlp_no/velocity_u{0}.npy'.format(test_t[0]), g_u)
        np.save('../results/pre/mlp_no/velocity_v{0}.npy'.format(test_t[0]), g_v)