...
class GAN:
    def __init__(self, t, x, y, p, u, v):
        ...
        self.model_path = '../models/nonw/gan{0}.ckpt'
    ...
    def train(self):
        ...
        log_save_path = '../results/nonw/loss.txt'
...
if __name__ == '__main__':
    ...
    np.save('../results/nonw/pressure{0}.npy'.format(test_t[0]), g_p)
    np.save('../results/nonw/velocity_u{0}.npy'.format(test_t[0]), g_u)
    np.save('../results/nonw/velocity_v{0}.npy'.format(test_t[0]), g_v)
