...
if __name__ == '__main__':
    ...
    np.save('../results/gan/1 0.2 1_/pressure{0}.npy'.format(test_t[0]), g_p)
    np.save('../results/gan/1 0.2 1_/velocity_u{0}.npy'.format(test_t[0]), g_u)
    np.save('../results/gan/1 0.2 1_/velocity_v{0}.npy'.format(test_t[0]), g_v)
