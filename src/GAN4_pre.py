...
if __name__ == '__main__':
    ...
    for pre_id in range(400, 500):
        ...
        np.save('../results/pre/gan_0.4/pressure{0}.npy'.format(test_t[0]), g_p)
        np.save('../results/pre/gan_0.4/velocity_u{0}.npy'.format(test_t[0]), g_u)
        np.save('../results/pre/gan_0.4/velocity_v{0}.npy'.format(test_t[0]), g_v)